...
def build_evaluator(cfg, dataset_name, output_folder=None):
    ...
    evaluator_list = []
    evaluator_type = MetadataCatalog.get(dataset_name).evaluator_type # coco
...
def main(args):
    ...
    if args.eval_only:
        ...
        print("cscscscscscscscscscscscscscscscscs")
    ...
    """
    # Trainer初始化时，便完成了build_model、build_optimizer、build_train_loader
    # build_lr_scheduler、register_hooks等等
    trainer = Trainer(cfg)
