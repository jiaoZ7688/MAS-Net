...
from detectron2.modeling.roi_heads.label_smooth import LabelSmoothSoftmaxCEV1 as LSSCE
...
class ABL(nn.Module):
    def __init__(self, isdetach=True, max_N_ratio = 1/28, ignore_label = 255, label_smoothing=0.2, weight = None, max_clip_dist = 20.):
    ...
    def forward(self, logits, target):
        ...
        if pred_boundary.sum() < 1: # avoid nan
            return torch.tensor(0.) # you should check in the outside. if None, skip this loss.
