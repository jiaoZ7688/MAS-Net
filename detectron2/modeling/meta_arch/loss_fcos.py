...
import os
from detectron2.layers import IOULoss
#from detectron2.layers import SigmoidFocalLoss
...
class FCOSLossComputation(object):
    ...
    def compute_targets_for_locations(self, locations, targets, object_sizes_of_interest):
        ...
        for im_i in range(len(targets)):
            ...
            gt_bboxes = targets_per_im.gt_boxes
            ...
            labels_per_im[locations_to_min_area == INF] = 80 # 80 is bg ###############################
