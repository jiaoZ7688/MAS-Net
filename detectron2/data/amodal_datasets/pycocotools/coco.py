...
import detectron2.data.amodal_datasets.pycocotools.mask as maskUtils
import os
    ...
    def createIndex(self):
        ...
        if 'annotations' in self.dataset:
            for ann in self.dataset['annotations']:
                ...
                # elif "i_segmentation" in ann.keys():
                #     ann['area'] = maskUtils.area(ann['i_segmentation']) / ann['area']
